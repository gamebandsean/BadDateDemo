...
export function buildDaterSystemPrompt(dater, phase = 'chat') {
  ...
  const phaseContext = phase === 'chat' 
    ? `You're chatting on a dating app before meeting in person. Keep responses flirty but brief (1-3 sentences). You're trying to gauge if this person is worth meeting.`
    : `You're on a first date at a nice restaurant. The conversation is flowing. React naturally to what your date reveals about themselves. Be expressive about your feelings - if something is a red flag, show concern. If something matches your interests, get excited!`
...
- If they mention something that's a dealbreaker, show subtle concern or discomfort
...
- Don't be afraid to flirt if things are going well
